...
class CoursDetail extends StatefulWidget {
  final int selectedCours;
  const CoursDetail(this.selectedCours);
  @override
...
class _CoursDetailState extends State<CoursDetail> {
  ...
  void initState() {
    super.initState();
    _coursDetailBloc = CoursDetailBloc(widget.selectedCours);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () =>
            _coursDetailBloc.fetchCoursDetail(widget.selectedCours),
